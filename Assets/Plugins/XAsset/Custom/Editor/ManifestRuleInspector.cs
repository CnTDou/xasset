...
public class ManifestRuleInspector : Editor
{
    ...
    const string AssetRoot = "Assets/Resource/";
    ...
    void OnEnable()
    {
        ...
        fullAssetRoot = Application.dataPath + "/Resource/";
    }
    ...
    bool isSelect = false;
    BuildType buildType = BuildType.Package;
        ...
        { 
            ...
            EditorGUILayout.BeginVertical("box");
            {
                ...
                if (t.ruleInfos.Count > 0)
                {
                    ...
                    if (isSelect)
                    {
                        buildType = (BuildType)EditorGUILayout.EnumPopup("查看 BuildType = ", buildType);
                    }
                    ...
                    for (int i = 0; i < t.ruleInfos.Count; i++)
                    {
                        ...
                        if (isSelect && value.buildType != buildType)
                        {
                            continue;
                        }
